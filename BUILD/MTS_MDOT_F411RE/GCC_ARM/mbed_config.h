...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x01, 0xCF, 0x6B }                                                 // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0xD6, 0xAE, 0x0D, 0xC3, 0x49, 0xA9, 0xE8, 0x82, 0x13, 0x44, 0x52, 0xA2, 0xAB, 0x31, 0xA3, 0x8F } // set by application[*]
#define MBED_CONF_LORA_APPSKEY                                                { 0xB0, 0x2A, 0xCF, 0x0A, 0xDD, 0x1D, 0xCF, 0xCB, 0x49, 0xF7, 0x55, 0x96, 0x2B, 0x26, 0xB9, 0xCE } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_ADDRESS                                         0x26011773                                                                                         // set by application[*]
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0xBE, 0x84 }                                                 // set by application[*]
...
#define MBED_CONF_LORA_NWKSKEY                                                { 0x88, 0x7F, 0x48, 0xE1, 0x0E, 0x5C, 0xF1, 0x1B, 0x78, 0x2B, 0xC2, 0x75, 0x36, 0xEC, 0xCA, 0xD8 } // set by application[*]
